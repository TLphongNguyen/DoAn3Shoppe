    ...
    return (
        <div>
            ...
            <div className="wrap-category flex">
                <Drawer title="Thêm nhãn hàng" className='w-[40%]' onClose={onClose} open={openLayout} width={1000}>
                    <div className="wrap-form w-[100%] mr-[50px] border-r-[1px] border-solid border-[#ccc]">
